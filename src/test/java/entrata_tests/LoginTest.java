...
//        DownloadReportPage.enterTextByPlaceholder("Username", username);
//        DownloadReportPage.enterTextByPlaceholder("Password", password);
...
//    }
    ...
    public void verifyDownloadReportInvalidData() throws Exception {
        ...
        Assertions.assertThat(loginPage().verifyOptionsOfResidentLogin("App")).isTrue();
        Assertions.assertThat(loginPage().verifyOptionsOfResidentLogin("Website")).isTrue();
